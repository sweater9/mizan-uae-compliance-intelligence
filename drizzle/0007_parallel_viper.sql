...
--> statement-breakpoint
ALTER TABLE "company_profiles" ADD COLUMN "workspace_id" text;--> statement-breakpoint
...
ALTER TABLE "company_profiles" ADD CONSTRAINT "company_profiles_workspace_id_workspaces_id_fk" FOREIGN KEY ("workspace_id") REFERENCES "public"."workspaces"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
